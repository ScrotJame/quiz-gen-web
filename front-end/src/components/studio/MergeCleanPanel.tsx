      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-indigo-100 bg-gradient-to-r from-indigo-50/70 via-purple-50/50 to-pink-50/40 p-5 dark:border-indigo-900/40 dark:from-indigo-950/40 dark:via-purple-950/30 dark:to-zinc-900">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto shrink-0">
          ...
          <button
            ...
            className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2.5 text-xs font-bold text-white shadow-md shadow-indigo-600/25 transition-all hover:from-indigo-500 hover:to-purple-500 hover:shadow-lg disabled:opacity-50 active:scale-95 cursor-pointer min-h-[42px]"
          >
            {isCleaning ? (
              <>
        ...
        <div className="lg:col-span-7 flex flex-col space-y-2">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full rounded-2xl border border-zinc-200 bg-white p-3.5 sm:p-4 font-mono text-base sm:text-sm leading-relaxed text-zinc-900 shadow-xs placeholder:text-zinc-400 focus:border-indigo-500 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100"
            />
          </div>
        </div>
